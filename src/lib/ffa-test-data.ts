...
export const FFA_TEST_ATHLETES = {
  ...
  PPS: {
    ...
    date_nai: '14/12/1980',
    numrel: 'P5CVC84A8F6',
    description: 'PPS (Parcours Prévention Santé)',
  },
...
export const FFA_EXPECTED_RESPONSES = {
  ...
  // PPS valide
  PPS_VALIDE: 'O,O,N,O,000000,100,200,P5CVC84A8F6,DUPONT,JEAN,M,14/12/1980,FRA,PPS,14/09/2016,,,,,,,,,,,,,OK,',

  // CF valide
  CF_VALIDE: 'O,O,N,O,000000,100,200,CF030716,LEDOGAR,STEPHANE,M,14/12/1972,FRA,CF01,,,,,,,,,,,,,OK,',

  // Licence non valide
  LICENCE_NON_VALIDE: 'O,N,N,O,195303,100,200,1362109,DECHY,FREDERIC,M,01/07/1976,FRA,COMP,31/08/2015,,,,,,,,,,,,,NOK,LA RELATION (licence/TP/PPS) NE SERA PLUS VALIDE AU MOMENT DE LA COMPETITION.(PROx006)',
...
export const FFA_RELATION_FORMATS = {
  ...
  PPS: {
    pattern: /^P[A-Z0-9]{10}$/,
    description: 'PPS : P + 10 caractères alphanumériques',
    example: 'P5CVC84A8F6',
  },
