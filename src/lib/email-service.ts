      ...
      <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background: #f5f5f5;">
        <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <div style="padding: 40px 30px;">
            ...
            ${data.isGroupRegistration && data.registrantName ? `
            <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 16px; margin: 20px 0; border-radius: 4px;">
              <h4 style="color: #d97706; margin: 0 0 10px 0; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px;">👥 Inscription de groupe</h4>
              <p style="margin: 0 0 5px 0; color: #92400e;">Votre inscription a été effectuée par :</p>
              <p style="margin: 0; color: #1f2937; font-weight: 500;">${data.registrantName}</p>
              ${data.registrantEmail ? `<p style="margin: 5px 0 0 0; color: #92400e;"><a href="mailto:${data.registrantEmail}" style="color: #d97706; text-decoration: none;">${data.registrantEmail}</a></p>` : ''}
              <p style="margin: 10px 0 0 0; font-size: 13px; color: #92400e;">Pour toute modification ou question concernant votre inscription, contactez cette personne.</p>
            </div>
            ` : ''}
