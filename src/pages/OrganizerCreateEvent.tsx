                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-2">
                        ...
                        . Ce code permet de vérifier automatiquement les licences FFA et les PPS des participants.
                      </p>
                      <div className="mt-3 text-sm text-gray-700 bg-white rounded p-3 border border-blue-100">
                        ...
                        <ul className="list-disc list-inside space-y-1 text-gray-600">
                          ...
                          <li>Non-licenciés majeurs (≥18 ans) : PPS obligatoire (validité 3 mois)</li>
