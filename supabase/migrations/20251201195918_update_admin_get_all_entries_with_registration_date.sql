/*
  # Mettre à jour admin_get_all_entries avec registration_date

  1. Modifications
    - Supprimer l'ancienne fonction
    - Recréer avec `registration_date` dans le retour
*/

-- Supprimer l'ancienne fonction
DROP FUNCTION IF EXISTS admin_get_all_entries();

-- Recréer avec registration_date
...
BEGIN
  ...
  SELECT 
    ...
    a.email::text,
    a.phone_mobile::text,
    a.nationality_code::text,
    a.license_number::text,
    a.club::text,
    e.category::text,
    e.status::text,
    e.amount,
