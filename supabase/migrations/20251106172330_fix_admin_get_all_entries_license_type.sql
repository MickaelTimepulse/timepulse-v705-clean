/*
  # Fix admin_get_all_entries function - correct license_type source

  1. Problem
    - license_type was referenced from entries table but exists in athletes table
    - This caused the function to fail and return no results

  2. Solution
    - Use a.license_type from athletes table instead of e.license_type
*/
