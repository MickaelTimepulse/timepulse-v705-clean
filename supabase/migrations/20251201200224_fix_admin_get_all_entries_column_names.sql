/*
  # Corriger les noms de colonnes dans admin_get_all_entries

  1. Modifications
    - Corriger `birth_date` -> `birthdate`
    - Corriger `phone_mobile` -> `phone`
    - Corriger `nationality_code` -> `nationality`
    - Corriger `license_id` au lieu de `license_number`
    - Corriger `license_club` au lieu de `club`
*/
