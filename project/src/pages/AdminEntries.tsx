...
import { FileText, Download, Filter, Calendar, Users, DollarSign, Eye, Search, X, RotateCcw, Mail } from 'lucide-react';
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .update({
          ...
          refund_transaction_fees: refundWithFees,
      ...
      alert('Remboursement enregistré avec succès. Le remboursement Lyra doit être traité manuellement dans le back-office Lyra.');
              ...
              <table className="min-w-full divide-y divide-gray-200 text-sm">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase">Événement</th>
                  ...
                  {filteredEntries.map((entry) => (
                    <tr key={entry.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-3 py-3 whitespace-nowrap">
                        ...
                        <div className="text-xs text-gray-500">{entry.events?.city}</div>
                      </td>
