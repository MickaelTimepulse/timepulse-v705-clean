...
export default function AdminLayout({ children, title }: AdminLayoutProps) {
  ...
  const menuItems = [
    // Vue d'ensemble
    { icon: LayoutDashboard, label: 'Tableau de bord', path: '/admin/dashboard', section: 'overview' },
    { icon: BarChart3, label: 'Monitoring', path: '/admin/monitoring', section: 'overview' },
    { icon: Target, label: 'Suivi du Projet', path: '/admin/project-tracking', section: 'overview' },

    // Gestion des événements
    { icon: Users, label: 'Organisateurs', path: '/admin/organizers', section: 'events' },
    { icon: Calendar, label: 'Événements', path: '/admin/events', section: 'events' },
    { icon: FileText, label: 'Inscriptions', path: '/admin/entries', section: 'events' },
    { icon: Trophy, label: 'Résultats', path: '/admin/results', section: 'events' },
    { icon: UserCog, label: 'Athlètes', path: '/admin/athletes', section: 'events' },

    // Finance
    { icon: CreditCard, label: 'Finance', path: '/admin/finance', section: 'finance' },
    { icon: DollarSign, label: 'Commission', path: '/admin/commission', section: 'finance' },

    // Communication
    { icon: Paintbrush, label: 'Gestionnaire d\'Emails', path: '/admin/email-manager', section: 'communication' },
    { icon: MailOpen, label: 'Templates', path: '/admin/email-templates', section: 'communication' },
    { icon: BookOpen, label: 'Variables', path: '/admin/email-variables', section: 'communication' },
    { icon: Image, label: 'Assets', path: '/admin/email-assets', section: 'communication' },
    { icon: LineChart, label: 'Monitoring Emails', path: '/admin/email-monitoring', section: 'communication' },

    // Contenu du site
    { icon: FileCode, label: 'Pages Services', path: '/admin/services', section: 'website' },
    { icon: Shield, label: 'Page d\'Accueil', path: '/admin/homepage-features', section: 'website' },
    { icon: FileText, label: 'Pages statiques', path: '/admin/static-pages', section: 'website' },
    { icon: Video, label: 'Vidéos', path: '/admin/videos', section: 'website' },

    // Administration système
    { icon: UserCog, label: 'Utilisateurs Admin', path: '/admin/users', section: 'system' },
    { icon: Activity, label: 'Journaux d\'activité', path: '/admin/activity-logs', section: 'system' },
    { icon: Database, label: 'Sauvegardes', path: '/admin/backups', section: 'system' },
    { icon: Settings, label: 'Paramètres', path: '/admin/settings', section: 'system' },
    { icon: Layout, label: 'Footer du site', path: '/admin/footer-settings', section: 'system' },
    { icon: Rocket, label: 'Déploiement', path: '/admin/deployment', section: 'system', superAdminOnly: true },
  ];
