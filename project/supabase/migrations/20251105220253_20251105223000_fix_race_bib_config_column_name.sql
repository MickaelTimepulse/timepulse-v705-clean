/*
  # Fix race_bib_config column reference in register function

  1. Changes
    - Update register_athlete_with_quota_check to use correct column name 'mode'
    - Check if mode = 'auto' instead of checking auto_assign_number
