/*
  # Fix ON CONFLICT to use index instead of constraint

  1. Changes
    - Change ON CONFLICT ON CONSTRAINT to use the index columns directly
...
BEGIN
  ...
  -- Utiliser la liste des colonnes de l'index unique au lieu du nom de la contrainte
